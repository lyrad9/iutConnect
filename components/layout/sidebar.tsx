  ...
  return (
    <aside className={cn("flex-col w-64 border-r pt-6 pb-12", className)}>
      ...
      <div className="mt-6 px-4">
        <h3 className="mb-2 px-4 text-xs font-semibold uppercase text-muted-foreground">Your Groups</h3>
      ...
      <div className="mt-6 px-4">
        <h3 className="mb-2 px-4 text-xs font-semibold uppercase text-muted-foreground">Upcoming Events</h3>
        <div className="flex flex-col gap-1">
          <Link
