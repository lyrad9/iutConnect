    ...
    <div className="rounded-xl border bg-card shadow-sm">
      ...
      <div className="p-4">
        {users.length > 0 ? (
              ...
              <div key={user.id} className="flex items-start justify-between">
                <div className="flex gap-2">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">{user.mutualConnections} mutual connections</p>
                  </div>
                </div>
          ...
          <p className="text-center text-sm text-muted-foreground">No suggestions at the moment.</p>
        )}
      </div>
    </div>
  )
