  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div
          className={cn(
            "border-input absolute top-2 z-[100px] w-full rounded-md border",
            "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=open]:z-[100px]",
            !open && "hidden"
          )}
