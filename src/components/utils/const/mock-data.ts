...
export const mockPosts: PostType[] = [
  {
    ...
    author: mockUsers[0],
    content:
      "Just finished my final project for the semester! 🎉 So excited to present it tomorrow. Anyone else finishing up their projects?",
  ...
  },
  {
    ...
    author: mockUsers[1],
    content:
      "Our business club is hosting a networking event next week! Don't miss the opportunity to connect with industry professionals and fellow students.",
  ...
  },
  {
    ...
    author: mockUsers[3],
    content:
      "Check out these photos from our engineering lab! We're working on some exciting new robotics projects. 🤖",
